...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('CyberDuel') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/images/CYBERDUEL-LOGO-1.png">
    <link rel="icon" type="image/png" href="{{ asset('material') }}/images/CYBERDUEL-LOGO-1.png">
    ...
    <body class="{{ $class ?? '' }}">
        ...
        <script src="{{ asset('material') }}/js/custom/custom.js"></script>
         <!-- Plugin for the Toaster  -->
